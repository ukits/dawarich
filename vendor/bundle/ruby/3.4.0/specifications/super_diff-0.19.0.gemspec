# -*- encoding: utf-8 -*-
# stub: super_diff 0.19.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<attr_extras>.freeze, [">= 6.2.4".freeze, "< 8".freeze])
  s.add_runtime_dependency(%q<diff-lcs>.freeze, ["~> 1.5".freeze])
  s.add_runtime_dependency(%q<patience_diff>.freeze, ["~> 1.2".freeze])
end
