# -*- encoding: utf-8 -*-
# stub: activerecord-postgis-adapter 11.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "activerecord-postgis-adapter".freeze
  s.version = "11.1.1".freeze
  ...
  s.add_runtime_dependency(%q<rgeo-activerecord>.freeze, ["~> 8.1.0".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.0".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 5.4".freeze])
  s.add_development_dependency(%q<minitest-excludes>.freeze, ["~> 2.0".freeze])
